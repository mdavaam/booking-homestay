                                    ...
                                    <tbody>
                                        @forelse ($transaksi as $i => $trx)
                                            ...
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge bg-warning text-dark text-capitalize">{{ $trx->status }}</span>
                                                </td>
                                                <td>Rp{{ number_format($trx->total_harga, 0, ',', '.') }}</td>

                                                <td>
                                                    <div class="booking-actions">
                                                        <form action="{{ route('batalkan-pesanan', $trx->id) }}"
                                                        ...
                                                        <a href="{{ route('pembayaran.lanjutan', $trx->kode_transaksi) }}"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="8" class="text-center">Tidak ada data transaksi.
                                                    </td>
                                                </tr>
                                        @endforelse
                                        </td>
