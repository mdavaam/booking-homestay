                            ...
                            <form method="GET" class="row gy-3 gx-2 align-items-end mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="daterange" id="daterange" class="form-control"
                                        placeholder="dd-mm-yyyy - dd-mm-yyyy" value="{{ request('daterange') }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    <select name="filter" id="filter" class="form-select">
                                        ...
                                        <option value="7" {{ request('filter') == 7 ? 'selected' : '' }}>7 Hari
                                            Terakhir</option>
                                        <option value="30" {{ request('filter') == 30 ? 'selected' : '' }}>30 Hari
                                            Terakhir</option>
                                        <option value="90" {{ request('filter') == 90 ? 'selected' : '' }}>90 Hari
                                            Terakhir</option>
                                    </select>
                                </div>
