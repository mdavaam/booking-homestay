...
<body>
            ...
            <div class="col-md-12">
                <div class="card mt-1 shadow-sm">
                    <div class="card-body">
                        ...
                        @endif
                        <h5 class="card-title mb-3">Tipe Kamar Tersedia</h5>
                        <div class="mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning btn-sm me-1"
                                                    ...
                                                    data-bs-target="#editModal{{ $kamar->id }}">Edit</button>
                                                <form action="{{ route('admin.kamardepan.destroy', $kamar->id) }}"
                ...
                <form action="{{ route('admin.jeniskamar') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="photo_kamar" name="photo_kamar"
                                accept="image/*">
                        </div>
                    </div>
    ...
    @foreach ($kamars as $kamar)
        <div class="modal fade" id="editModal{{ $kamar->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('admin.update', $kamar->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel{{ $kamar->id }}">Edit Data Tipe Kamar</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="jenis_kamar{{ $kamar->id }}" name="jenis_kamar"
                            ...
                            <div class="mb-3">
                                <label for="harga_permalam{{ $kamar->id }}" class="form-label">Harga Per
                                    Malam</label>
                                <input type="number" id="harga_permalam{{ $kamar->id }}" name="harga_permalam"
                            ...
                            <div class="mb-3">
                                ...
                                @if ($kamar->photo_kamar)
                                    <img src="{{ asset('storage/' . $kamar->photo_kamar) }}" alt="Current Photo"
                                        class="mt-2 rounded" style="width: 150px;">
                                @endif
                            </div>
