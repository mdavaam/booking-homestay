        ...
        <div class="container">
            ...
            <button class="navbar-toggler custom-toggler" type="button" data-bs-toggle="collapse"
                ...
                <span class="toggler-icon">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                        ...
                        <path class="bar middle-bar" d="M5 15H25" stroke="#333" stroke-width="2"
                            stroke-linecap="round" />
                        <path class="bar bottom-bar" d="M5 23H25" stroke="#333" stroke-width="2"
                            stroke-linecap="round" />
                    </svg>
                </span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <button class="nav-link btn btn-primary text-dark ms-3 btn-oval" data-bs-toggle="modal"
                            data-bs-target="#authModal">Login | Daftar</button>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <p class="text-center mt-3">
                            Belum punya akun? <a href="#" class="switch-to-register text-primary"
                                data-bs-toggle="modal" data-bs-target="#registerModal" data-bs-dismiss="modal">Daftar di
                                sini</a>
                        </p>
                        <p class="text-center mt-2">
                            <a href="#" class="text-primary" data-bs-toggle="modal"
                                data-bs-target="#resetPasswordModal" data-bs-dismiss="modal">Lupa Password?</a>
                        </p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <p class="text-center mt-3"><a href="#" class="text-primary" data-bs-toggle="modal"
