<div class="sidebar p-4">
    ...
    <div class="dropdown">
        <a class="dropdown-toggle d-block text-white" href="#" id="dropdownRooms" data-bs-toggle="collapse"
            data-bs-target="#collapseRooms" aria-expanded="false">
            <i class="fas fa-door-open me-2"></i> Rooms
        </a>
        <div class="collapse ms-3" id="collapseRooms">
            <a class="d-block text-white" href="{{ route('admin.tipekamar') }}">Tipe Kamar</a>
            <a class="d-block text-white" href="{{ route('admin.kamardalam') }}">Kamar</a>
        </div>
        <a href="{{ route('admin.pemesanan') }}"><i class="fas fa-bed me-2"></i>Bookings</a>
    </div>
